...
function App() {
  ...
  const handleContactClick = () => {
    const message = 'Hi! I would like to get in touch with you regarding your jewelry collection.';
    window.open(`https://${WHATSAPP_URL}?text=${encodeURIComponent(message)}`, '_blank');
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li><a className="text-sm text-muted-foreground hover:text-amber-600 transition-colors" href={`https://${WHATSAPP_URL}?text=${encodeURIComponent('Hi! I would like to get in touch with you regarding your jewelry collection.')}`} target="_blank" rel="noopener noreferrer">Contact Us</a></li>
              </ul>
            </div>
            <div>
